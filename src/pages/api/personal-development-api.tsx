...
export default async (req, res) => {
  var dataTotal=[],i;
    ...
    async function getSortedPostsData0() {
      ...
      const res = await fetch("https://teachinguide.azure-api.net/course-coupon?sortCol=students&sortDir=DESC&length=50&inkw=&discount=100&language=English&cat=Personal%20Development%7CHealth%20%26%20Fitness%7CLifestyle", {
        "headers": {
