  ...
  const res = await fetch(
    "https://teachinguide.azure-api.net/course-coupon?sortCol=students&sortDir=DESC&length=12&page=1&inkw=&discount=100&language=English&cat=Development%7CIT%20%26%20Software",
    {
      headers: {
        ...
        authorization:
          "eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJ1c2VyX2lkIjo1OTIxNCwiZW1haWxfaWQiOiJrZXZpbmFobWFkLmZAZ21haWwuY29tIiwicGxhbiI6Ik9OX1RSSUFMIiwic3ViX3BsYW4iOiJPTl9UUklBTCIsInBsYW5fcGVyaW9kIjpudWxsfQ.5X5Gh93LEynveLK8LrTuRnYi6hSLreXR1CPqz1M5zqQ",
